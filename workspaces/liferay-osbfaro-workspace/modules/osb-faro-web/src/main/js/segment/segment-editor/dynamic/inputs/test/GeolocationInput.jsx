...
describe('GeolocationInput', () => {
	...
	it('renders inputs for all location values if they all have non-zero length values', () => {
		const {container} = render(
			<WrapperComponent>
				<GeolocationInput
					onChange={jest.fn()}
	...
	it('renders the region input as a button if the initial value for the input was empty', () => {
		const {container} = render(
			<WrapperComponent>
				<GeolocationInput
					onChange={jest.fn()}
	...
	it('renders the city input as a button if the initial value for the input was empty', () => {
		const {container} = render(
			<WrapperComponent>
				<GeolocationInput
					onChange={jest.fn()}
