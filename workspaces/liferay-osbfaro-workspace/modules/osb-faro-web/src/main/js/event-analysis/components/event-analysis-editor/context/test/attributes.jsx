...
describe('attributes', () => {
	...
	describe('isAttributeInUse', () => {
		it('returns false if no attributes are in use', () => {
			expect(
				isAttributeInUse(
					'2',
		...
		it('returns true if at least 1 attribute is in use', () => {
			expect(
				isAttributeInUse(
					'1',
					initialAttributes.breakdowns,
	...
	describe('attributesReducer', () => {
		...
		it('EditBreakdowns and not delete attribute if attribute is being used by filter', () => {
		...
		it('EditFilters and not delete attribute if attribute is being used by breakdown', () => {
			const attributes = attributesReducer(initialAttributes, {
				payload: {
					attribute,
					filter,
