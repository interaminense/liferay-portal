...
describe('Event Analysis Create', () => {
	...
	it('renders disabled button to save event analysis', async () => {
	...
	it('enables the save button when there is at least one name and one event added', async () => {
		const {container, getByText} = render(<WrappedComponent />);
	...
	it('contains a link to return to the event analysis list on the cancel button', () => {
