...
describe('UsageOverview', () => {
	...
	it('renders with a warning type and danger type warning if one metric is approaching limit and the other is over', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('renders with an approaching limit warning if a metric is approaching plan limit', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('renders the total number of INDIVIDUALS since last anniversary and the percentage used in the plan', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('displays the plan count percentage as 100% for INDIVIDUALS when count is higher than limit', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('displays the plan count percentage as 100% for PAGE VIEWS when count is higher than limit', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('displays the limit of INDIVIDUALS and PAGE VIEWS. Also, it should render a warning if INDIVIDUALS is over the limit. Also, it should render the current plan name.', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('renders the total of PAGE VIEWS since the last anniversary and the percentage used in the plan', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('renders with an overage warning if the PAGE VIEWS metric has exceeded the plan limit', () => {
		useCurrentUser.mockImplementation(() => ({isAdmin: () => true}));
	...
	it('renders with a member-specific message overage warning if a metric is approaching plan limit and the user is a member role', () => {
