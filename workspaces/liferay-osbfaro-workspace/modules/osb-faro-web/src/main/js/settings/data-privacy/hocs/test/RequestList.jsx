...
describe('RequestList', () => {
	...
	it('renders a request row as checkable with a download button if the status is "DONE"', async () => {
		const {container} = render(
			<Wrapper>
				<RequestList
					currentUser={new User({roleName: 'Site Owner'})}
	...
	it('renders a request row as disabled with no download button if the status is not "DONE"', async () => {
		const {container} = render(
			<Wrapper>
				<RequestList
					currentUser={new User({roleName: 'Site Owner'})}
	...
	it('renders a request row as disabled with a "download expired" message if the request status is EXPIRED', async () => {
		const {container} = render(
			<Wrapper>
				<RequestList
					currentUser={new User({roleName: 'Site Owner'})}
