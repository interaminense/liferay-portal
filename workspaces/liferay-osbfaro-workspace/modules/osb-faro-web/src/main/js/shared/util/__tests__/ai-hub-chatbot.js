...
describe('AI Hub chatbot', () => {
	...
	// Stands in for the widget, which builds this host itself once its own
	// script runs. jsdom never fetches that script, so the tests that care
	// about the host put one on the page by hand.
