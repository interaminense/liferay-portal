...
const EventsByUserSessionsResolver = function EventsByUserSessionsResolver() {
	return {
			...
			},
			{
				...
				events: [
					...
					},
					{
						...
						referrer:
							'https://learn-dev.liferay.com/c/portal/logout',
						url: 'https://learn-dev.liferay.com/home',
					},
					{
						__typename: 'Event',
...
export default EventsByUserSessionsResolver;
