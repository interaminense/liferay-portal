...
import {PAGE_OVERVIEW_QUERY, PageMetric} from '../../lib/analytics';
...
import {PageOverviewCardContent} from './PageOverviewCardContent';

export interface PageOverviewCardIProps {
...
export const PageOverviewCard: React.FC<PageOverviewCardIProps> = ({
	aiInsightsEnabled,
	channelId,
	rangeSelectors,
	title,
	...
	return (
		<StatesRenderer error={!!error} loading={loading}>
			...
			<StatesRenderer.Success>
				<>
					<PageOverviewCardContent metric={data?.page ?? null} />

					<AIInsightCallout
						data={data?.page ?? null}
						enabled={aiInsightsEnabled}
						metricLabel="Page Overview"
					/>
				</>
			</StatesRenderer.Success>
		</StatesRenderer>
