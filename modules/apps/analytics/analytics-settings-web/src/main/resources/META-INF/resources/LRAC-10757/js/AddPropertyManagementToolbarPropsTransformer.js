...
export default function propsTransformer({portletNamespace, ...otherProps}) {
	...
	return {
		...
		onCreateButtonClick: (event, {item}) => {
			...
			// openSelectionModal({
				// id: `${portletNamespace}addProperty`,
				// onSelect: (selectedItem) => {
				// 	const addPropertyURL = createPortletURL(
				// 		data?.addPropertyURL,
				// 		{
