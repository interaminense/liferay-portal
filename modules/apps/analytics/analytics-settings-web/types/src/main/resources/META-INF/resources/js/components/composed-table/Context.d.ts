...
import {TItem} from './ComposedTable';
...
interface IComposedTableContext {
	firstColumn: string;
}
declare const ComposedTableContext: React.FC<IComposedTableContext>;
export {useData, useDispatch};
export default ComposedTableContext;
