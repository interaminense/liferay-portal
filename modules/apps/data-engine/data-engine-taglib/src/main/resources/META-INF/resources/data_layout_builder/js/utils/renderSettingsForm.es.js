...
import {generateName, PagesVisitor} from 'dynamic-data-mapping-form-renderer';
...
export const getFilteredSettingsContext = ({config, editingLanguageId, settingsContext}) => {
