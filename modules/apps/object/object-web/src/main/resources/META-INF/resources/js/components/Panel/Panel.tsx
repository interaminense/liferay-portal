	...
	return (
		...
		>
			<div className="object-admin-panel__header__content-left">
				...
				{contentLeft && <span className="align-items-center d-flex ml-2">{contentLeft}</span>}
			</div>
			<div className="object-admin-panel__header__content-right">
				{contentRight && <span className="align-items-center d-flex ml-2">{contentRight}</span>}
