...
public class FaroUserPersistenceImpl
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathCountByKey, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByKey, args, faroUserModelImpl);
		...
		finderCache.putResult(
			_finderPathCountByG_L, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByG_L, args, faroUserModelImpl);
		...
		finderCache.putResult(
			_finderPathCountByG_E, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByG_E, args, faroUserModelImpl);
	}
