 ...
 * @author Matthew Kong
 */
public class NoSuchFaroProjectEmailDomainException extends NoSuchModelException {
	...
	public NoSuchFaroProjectEmailDomainException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
