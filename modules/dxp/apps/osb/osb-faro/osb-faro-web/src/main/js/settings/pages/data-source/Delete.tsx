...
export const Delete: React.FC<IDeleteProps> = ({
	addAlert,
	className,
	dataSource,
	deleteDataSource,
	...
	return (
		<BasePage
			...
			documentTitle={
				sub(Liferay.Language.get('confirm-removal-of-x'), [
					dataSource.name
				]) as string
			}
		...
		>
			<div className='page-container'>
				<WrappedDeleteDataSource
					actionRequestFn={handleDeleteDataSource}
					dataSource={dataSource}
					deleteMessage={sub(
						Liferay.Language.get(
...
)(Delete) as React.ComponentType<any>;
