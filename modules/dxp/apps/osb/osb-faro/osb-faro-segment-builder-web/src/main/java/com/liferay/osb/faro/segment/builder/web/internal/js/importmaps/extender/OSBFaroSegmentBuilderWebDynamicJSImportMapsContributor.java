...
package com.liferay.osb.faro.segment.builder.web.internal.js.importmaps.extender;
 ...
 * <code>@liferay/osb-faro-segment-builder-web</code> to the exported bundle
 * shipped by this module, so analytics-cloud and any other consumer can
 * import the segment-builder engine via its package name and have the
 * portal resolve it at runtime.
 *
 * @author Adriano Interaminense
 */
@Component(service = DynamicJSImportMapsContributor.class)
public class OSBFaroSegmentBuilderWebDynamicJSImportMapsContributor
